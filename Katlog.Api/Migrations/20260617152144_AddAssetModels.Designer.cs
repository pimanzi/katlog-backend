...
namespace Katlog.Api.Migrations
{
    ...
    [Migration("20260617152144_AddAssetModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Katlog.Api.Models.Asset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Katlog.Api.Models.AssetStatusHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Katlog.Api.Models.AssetTag", b =>
                {
                    b.Property<int>("AssetId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Katlog.Api.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Katlog.Api.Models.Variant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Katlog.Api.Models.Asset", b =>
                {
                    b.HasOne("Katlog.Api.Models.Product", "Product")
                        .WithMany("Assets")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Katlog.Api.Models.Variant", "Variant")
                        .WithMany("Assets")
            ...
            modelBuilder.Entity("Katlog.Api.Models.AssetStatusHistory", b =>
                {
                    b.HasOne("Katlog.Api.Models.Asset", "Asset")
            ...
            modelBuilder.Entity("Katlog.Api.Models.AssetTag", b =>
                {
                    ...
                    b.HasOne("Katlog.Api.Models.Tag", "Tag")
                        .WithMany("AssetTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
