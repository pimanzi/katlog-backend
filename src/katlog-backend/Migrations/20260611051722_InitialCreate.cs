        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_Season", "\"Season\" IN ('Spring','Summer','Autumn','Winter')");
                    table.CheckConstraint("CK_Products_Status", "\"Status\" IN ('Draft','Review','Published','Archived')");
                    table.ForeignKey(
